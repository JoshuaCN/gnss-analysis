function [gpsEph,iono] = ReadRinexNavBds(fileName)
...
for j = 1:numEph
   ...
   month  = str2num(line(9:11));
   day    = str2num(line(12:14));
   hour   = str2num(line(15:17));
   minute = str2num(line(18:20));
   second = str2num(line(21:23));
...
while 1
    ...
    if line == -1, 
        break;  
    elseif length(line)~=80 && length(line)~=42
